...
@Component({
  selector: 'web-app-gravity-points-header',
  templateUrl: './gravity-points-header.component.html',
  styleUrls: ['./gravity-points-header.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class GravityPointsHeaderComponent implements AfterViewInit {
